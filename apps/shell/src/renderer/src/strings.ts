...
export const strings = {
  zh: {
    ...
    setAiKeyOptional: '可留空（仅反向代理需要）',
    setAiAnalysisModelHint: '读取图片的视觉模型。留空则沿用对话模型。',
    setAiAnalysisSameAsChat: '与对话模型相同',
    setAiDaemon: 'Ollama 服务',
    setAiDaemonUp: 'Ollama {version} · 已安装 {n} 个模型',
    setAiDaemonDown: '无法连接 Ollama。请先运行 “ollama serve”。',
    setAiNoModels: '尚未安装模型 — 先运行 “ollama pull llama3.2”。',
    setAiRefreshModels: '刷新',
    setAiLocalHint: '全部在本机通过 Ollama 运行。无需账号与 API Key，数据不离开本机。',
    setAiModelNoTools: '该模型不支持工具调用，AI 无法编辑文档。',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服务商',
    setAiModelId: '模型',
    setAiApiKey: 'API Key',
  ...
  en: {
    ...
    setAiKeyOptional: 'Optional — only for a guarded proxy',
    setAiAnalysisModelHint: 'The vision model that reads images. Leave empty to reuse the chat model.',
    setAiAnalysisSameAsChat: 'Same as the chat model',
    setAiDaemon: 'Ollama daemon',
    setAiDaemonUp: 'Ollama {version} · {n} models installed',
    setAiDaemonDown: 'Ollama is not reachable. Start it with “ollama serve”.',
    setAiNoModels: 'No models installed yet — pull one with “ollama pull llama3.2”.',
    setAiRefreshModels: 'Refresh',
    setAiLocalHint:
      'Runs entirely on your machine through Ollama. No account, no API key, nothing leaves the device.',
    setAiModelNoTools: 'This model cannot call tools, so the AI cannot edit documents.',
  ...
  ja: {
    ...
    setAiKeyOptional: '任意（保護されたプロキシ用）',
    setAiAnalysisModelHint: '画像を読むビジョンモデル。空欄ならチャット用モデルを使います。',
    setAiAnalysisSameAsChat: 'チャットと同じモデル',
    setAiDaemon: 'Ollama サービス',
    setAiDaemonUp: 'Ollama {version} · モデル {n} 件',
    setAiDaemonDown: 'Ollama に接続できません。「ollama serve」で起動してください。',
    setAiNoModels: 'モデルが未インストールです —「ollama pull llama3.2」で取得してください。',
    setAiRefreshModels: '更新',
    setAiLocalHint:
      'すべて Ollama でこの端末上で動作します。アカウントも API キーも不要で、データは外部に出ません。',
    setAiModelNoTools:
      'このモデルはツール呼び出しに対応していないため、AI は文書を編集できません。',
    setSecAiModel: 'AIモデル',
  ...
  ko: {
    ...
    setAiKeyOptional: '선택 사항 — 보호된 프록시에만 필요',
    setAiAnalysisModelHint: '이미지를 읽는 비전 모델입니다. 비워 두면 채팅 모델을 씁니다.',
    setAiAnalysisSameAsChat: '채팅 모델과 동일',
    setAiDaemon: 'Ollama 데몬',
    setAiDaemonUp: 'Ollama {version} · 모델 {n}개 설치됨',
    setAiDaemonDown: 'Ollama에 연결할 수 없습니다. “ollama serve”로 실행하세요.',
    setAiNoModels: '설치된 모델이 없습니다 — “ollama pull llama3.2”로 받아오세요.',
    setAiRefreshModels: '새로고침',
    setAiLocalHint:
      '모두 이 기기의 Ollama에서 실행됩니다. 계정과 API 키가 필요 없고 데이터는 외부로 나가지 않습니다.',
    setAiModelNoTools: '이 모델은 도구 호출을 지원하지 않아 AI가 문서를 편집할 수 없습니다.',
    setSecAiModel: 'AI 모델',
    setAiProvider: '제공업체',
    setAiModelId: '모델',
    setAiApiKey: 'API 키',
  ...
  fr: {
    ...
    setAiKeyOptional: 'Facultatif — uniquement pour un proxy protégé',
    setAiAnalysisModelHint: 'Le modèle de vision qui lit les images. Laissez vide pour réutiliser le modèle de chat.',
    setAiAnalysisSameAsChat: 'Identique au modèle de chat',
    setAiDaemon: 'Service Ollama',
    setAiDaemonUp: 'Ollama {version} · {n} modèles installés',
    setAiDaemonDown: 'Ollama est injoignable. Lancez-le avec « ollama serve ».',
    setAiNoModels: 'Aucun modèle installé — récupérez-en un avec « ollama pull llama3.2 ».',
    setAiRefreshModels: 'Actualiser',
    setAiLocalHint:
      'Tout s’exécute sur votre machine via Ollama. Aucun compte, aucune clé API, rien ne quitte l’appareil.',
    setAiModelNoTools:
      'Ce modèle ne sait pas appeler d’outils : l’IA ne peut donc pas modifier les documents.',
  ...
  de: {
    ...
    setAiKeyOptional: 'Optional — nur für einen geschützten Proxy',
    setAiAnalysisModelHint: 'Das Vision-Modell, das Bilder liest. Leer lassen, um das Chat-Modell zu verwenden.',
    setAiAnalysisSameAsChat: 'Wie das Chat-Modell',
    setAiDaemon: 'Ollama-Dienst',
    setAiDaemonUp: 'Ollama {version} · {n} Modelle installiert',
    setAiDaemonDown: 'Ollama ist nicht erreichbar. Starte es mit „ollama serve“.',
    setAiNoModels: 'Noch kein Modell installiert — hole eines mit „ollama pull llama3.2“.',
    setAiRefreshModels: 'Aktualisieren',
    setAiLocalHint:
      'Läuft vollständig lokal über Ollama. Kein Konto, kein API-Key, nichts verlässt das Gerät.',
    setAiModelNoTools:
      'Dieses Modell kann keine Werkzeuge aufrufen — die KI kann damit keine Dokumente bearbeiten.',
  ...
  es: {
    ...
    setAiKeyOptional: 'Opcional: solo para un proxy protegido',
    setAiAnalysisModelHint: 'El modelo de visión que lee imágenes. Déjalo vacío para reutilizar el modelo de chat.',
    setAiAnalysisSameAsChat: 'Igual que el modelo de chat',
    setAiDaemon: 'Servicio Ollama',
    setAiDaemonUp: 'Ollama {version} · {n} modelos instalados',
    setAiDaemonDown: 'No se puede conectar con Ollama. Inícialo con «ollama serve».',
    setAiNoModels: 'Aún no hay modelos instalados: descarga uno con «ollama pull llama3.2».',
    setAiRefreshModels: 'Actualizar',
    setAiLocalHint:
      'Todo se ejecuta en tu equipo mediante Ollama. Sin cuenta ni clave API; nada sale del dispositivo.',
    setAiModelNoTools:
      'Este modelo no admite llamadas a herramientas, así que la IA no puede editar documentos.',
  ...
  th: {
    ...
    setAiKeyOptional: 'ไม่บังคับ — ใช้เฉพาะพร็อกซีที่มีการป้องกัน',
    setAiAnalysisModelHint: 'โมเดลวิชันที่ใช้อ่านรูป เว้นว่างเพื่อใช้โมเดลแชท',
    setAiAnalysisSameAsChat: 'เหมือนโมเดลแชท',
    setAiDaemon: 'บริการ Ollama',
    setAiDaemonUp: 'Ollama {version} · ติดตั้งแล้ว {n} โมเดล',
    setAiDaemonDown: 'เชื่อมต่อ Ollama ไม่ได้ เริ่มด้วย “ollama serve”',
    setAiNoModels: 'ยังไม่มีโมเดล — ดึงมาด้วย “ollama pull llama3.2”',
    setAiRefreshModels: 'รีเฟรช',
    setAiLocalHint:
      'ทำงานบนเครื่องของคุณทั้งหมดผ่าน Ollama ไม่ต้องมีบัญชีหรือคีย์ API และข้อมูลไม่ออกจากเครื่อง',
    setAiModelNoTools: 'โมเดลนี้เรียกใช้เครื่องมือไม่ได้ AI จึงแก้ไขเอกสารไม่ได้',
  ...
  id: {
    ...
    setAiKeyOptional: 'Opsional — hanya untuk proxy yang dilindungi',
    setAiAnalysisModelHint: 'Model visi yang membaca gambar. Kosongkan untuk memakai model obrolan.',
    setAiAnalysisSameAsChat: 'Sama dengan model obrolan',
    setAiDaemon: 'Layanan Ollama',
    setAiDaemonUp: 'Ollama {version} · {n} model terpasang',
    setAiDaemonDown: 'Ollama tidak dapat dihubungi. Jalankan dengan “ollama serve”.',
    setAiNoModels: 'Belum ada model — ambil satu dengan “ollama pull llama3.2”.',
    setAiRefreshModels: 'Segarkan',
    setAiLocalHint:
      'Berjalan sepenuhnya di perangkat Anda lewat Ollama. Tanpa akun, tanpa kunci API, tidak ada data yang keluar.',
    setAiModelNoTools:
      'Model ini tidak bisa memanggil alat, jadi AI tidak dapat menyunting dokumen.',
  ...
  ru: {
    ...
    setAiKeyOptional: 'Необязательно — только для защищённого прокси',
    setAiAnalysisModelHint: 'Модель зрения для чтения изображений. Пусто — использовать модель чата.',
    setAiAnalysisSameAsChat: 'Как модель чата',
    setAiDaemon: 'Служба Ollama',
    setAiDaemonUp: 'Ollama {version} · установлено моделей: {n}',
    setAiDaemonDown: 'Ollama недоступна. Запустите её командой «ollama serve».',
    setAiNoModels: 'Моделей пока нет — загрузите одну: «ollama pull llama3.2».',
    setAiRefreshModels: 'Обновить',
    setAiLocalHint:
      'Всё работает локально через Ollama. Ни аккаунта, ни API-ключа — данные не покидают устройство.',
    setAiModelNoTools:
      'Эта модель не умеет вызывать инструменты, поэтому ИИ не сможет править документы.',
  ...
  ar: {
    ...
    setAiKeyOptional: 'اختياري — لوكيل محمي فقط',
    setAiAnalysisModelHint: 'نموذج الرؤية الذي يقرأ الصور. اتركه فارغًا لاستخدام نموذج المحادثة.',
    setAiAnalysisSameAsChat: 'نفس نموذج المحادثة',
    setAiDaemon: 'خدمة Ollama',
    setAiDaemonUp: 'Ollama {version} · {n} نماذج مثبّتة',
    setAiDaemonDown: 'تعذّر الوصول إلى Ollama. شغّلها بالأمر «ollama serve».',
    setAiNoModels: 'لا توجد نماذج بعد — نزّل واحدًا بالأمر «ollama pull llama3.2».',
    setAiRefreshModels: 'تحديث',
    setAiLocalHint:
      'يعمل بالكامل على جهازك عبر Ollama. بلا حساب ولا مفتاح API، ولا تغادر البيانات الجهاز.',
    setAiModelNoTools:
      'هذا النموذج لا يستدعي الأدوات، لذا لا يستطيع الذكاء الاصطناعي تحرير المستندات.',
  ...
  pt: {
    ...
    setAiKeyOptional: 'Opcional — apenas para um proxy protegido',
    setAiAnalysisModelHint: 'O modelo de visão que lê imagens. Deixe vazio para reutilizar o modelo de chat.',
    setAiAnalysisSameAsChat: 'Igual ao modelo de chat',
    setAiDaemon: 'Serviço Ollama',
    setAiDaemonUp: 'Ollama {version} · {n} modelos instalados',
    setAiDaemonDown: 'Não foi possível acessar o Ollama. Inicie-o com “ollama serve”.',
    setAiNoModels: 'Nenhum modelo instalado — baixe um com “ollama pull llama3.2”.',
    setAiRefreshModels: 'Atualizar',
    setAiLocalHint:
      'Tudo roda na sua máquina via Ollama. Sem conta, sem chave de API; nada sai do dispositivo.',
    setAiModelNoTools:
      'Este modelo não chama ferramentas, portanto a IA não consegue editar documentos.',
    setSecAiModel: 'Modelo de IA',
  ...
  it: {
    ...
    setAiKeyOptional: 'Facoltativo — solo per un proxy protetto',
    setAiAnalysisModelHint: 'Il modello di visione che legge le immagini. Lascia vuoto per usare quello della chat.',
    setAiAnalysisSameAsChat: 'Come il modello della chat',
    setAiDaemon: 'Servizio Ollama',
    setAiDaemonUp: 'Ollama {version} · {n} modelli installati',
    setAiDaemonDown: 'Ollama non è raggiungibile. Avvialo con «ollama serve».',
    setAiNoModels: 'Nessun modello installato — scaricane uno con «ollama pull llama3.2».',
    setAiRefreshModels: 'Aggiorna',
    setAiLocalHint:
      'Tutto gira sul tuo computer tramite Ollama. Nessun account, nessuna chiave API: nulla lascia il dispositivo.',
    setAiModelNoTools:
      'Questo modello non sa chiamare strumenti, quindi l’IA non può modificare i documenti.',
  ...
  pl: {
    ...
    setAiKeyOptional: 'Opcjonalnie — tylko dla chronionego proxy',
    setAiAnalysisModelHint: 'Model wizyjny czytający obrazy. Puste — użyj modelu czatu.',
    setAiAnalysisSameAsChat: 'Tak jak model czatu',
    setAiDaemon: 'Usługa Ollama',
    setAiDaemonUp: 'Ollama {version} · zainstalowane modele: {n}',
    setAiDaemonDown: 'Nie można połączyć się z Ollamą. Uruchom ją poleceniem „ollama serve”.',
    setAiNoModels: 'Brak modeli — pobierz jeden poleceniem „ollama pull llama3.2”.',
    setAiRefreshModels: 'Odśwież',
    setAiLocalHint:
      'Wszystko działa lokalnie przez Ollamę. Bez konta i klucza API — dane nie opuszczają urządzenia.',
    setAiModelNoTools:
      'Ten model nie potrafi wywoływać narzędzi, więc AI nie może edytować dokumentów.',
    setSecAiModel: 'Model AI',
  ...
  cs: {
    ...
    setAiKeyOptional: 'Volitelné – jen pro chráněnou proxy',
    setAiAnalysisModelHint: 'Vizuální model pro čtení obrázků. Prázdné – použije se model chatu.',
    setAiAnalysisSameAsChat: 'Stejný jako model chatu',
    setAiDaemon: 'Služba Ollama',
    setAiDaemonUp: 'Ollama {version} · nainstalovaných modelů: {n}',
    setAiDaemonDown: 'Ollama je nedostupná. Spusťte ji příkazem „ollama serve“.',
    setAiNoModels: 'Zatím žádný model — stáhněte si jej příkazem „ollama pull llama3.2“.',
    setAiRefreshModels: 'Obnovit',
    setAiLocalHint:
      'Vše běží lokálně přes Ollamu. Bez účtu a API klíče – data neopouštějí zařízení.',
    setAiModelNoTools: 'Tento model neumí volat nástroje, takže AI nemůže upravovat dokumenty.',
    setSecAiModel: 'Model AI',
  ...
  nl: {
    ...
    setAiKeyOptional: 'Optioneel — alleen voor een beveiligde proxy',
    setAiAnalysisModelHint: 'Het visiemodel dat afbeeldingen leest. Laat leeg om het chatmodel te gebruiken.',
    setAiAnalysisSameAsChat: 'Zelfde als het chatmodel',
    setAiDaemon: 'Ollama-service',
    setAiDaemonUp: 'Ollama {version} · {n} modellen geïnstalleerd',
    setAiDaemonDown: 'Ollama is niet bereikbaar. Start het met “ollama serve”.',
    setAiNoModels: 'Nog geen modellen — haal er een op met “ollama pull llama3.2”.',
    setAiRefreshModels: 'Vernieuwen',
    setAiLocalHint:
      'Draait volledig lokaal via Ollama. Geen account, geen API-sleutel; er verlaat niets dit apparaat.',
    setAiModelNoTools:
      'Dit model kan geen tools aanroepen, dus de AI kan geen documenten bewerken.',
    setSecAiModel: 'AI-model',
    setAiProvider: 'Provider',
    setAiModelId: 'Model',
  ...
  ms: {
    ...
    setAiKeyOptional: 'Pilihan — hanya untuk proksi yang dilindungi',
    setAiAnalysisModelHint: 'Model penglihatan yang membaca imej. Biarkan kosong untuk guna model sembang.',
    setAiAnalysisSameAsChat: 'Sama seperti model sembang',
    setAiDaemon: 'Perkhidmatan Ollama',
    setAiDaemonUp: 'Ollama {version} · {n} model dipasang',
    setAiDaemonDown: 'Ollama tidak dapat dihubungi. Mulakan dengan “ollama serve”.',
    setAiNoModels: 'Belum ada model — dapatkan satu dengan “ollama pull llama3.2”.',
    setAiRefreshModels: 'Segar semula',
    setAiLocalHint:
      'Berjalan sepenuhnya pada mesin anda melalui Ollama. Tiada akaun, tiada kunci API, tiada data keluar.',
    setAiModelNoTools:
      'Model ini tidak boleh memanggil alat, jadi AI tidak dapat menyunting dokumen.',
    setSecAiModel: 'Model AI',
    setAiProvider: 'Penyedia',
    setAiModelId: 'Model',
    setAiApiKey: 'Kunci API',
  ...
  he: {
    ...
    setAiKeyOptional: 'לא חובה — רק עבור פרוקסי מוגן',
    setAiAnalysisModelHint: 'מודל הראייה שקורא תמונות. השאירו ריק כדי להשתמש במודל הצ׳אט.',
    setAiAnalysisSameAsChat: 'כמו מודל הצ׳אט',
    setAiDaemon: 'שירות Ollama',
    setAiDaemonUp: 'Ollama {version} · {n} מודלים מותקנים',
    setAiDaemonDown: 'אין גישה ל-Ollama. הפעילו אותה עם ‏“ollama serve”.',
    setAiNoModels: 'עדיין אין מודלים — הורידו אחד עם ‏“ollama pull llama3.2”.',
    setAiRefreshModels: 'רענון',
    setAiLocalHint:
      'הכול רץ על המחשב שלך דרך Ollama. בלי חשבון ובלי מפתח API, ושום מידע לא יוצא מהמכשיר.',
    setAiModelNoTools: 'המודל הזה לא תומך בקריאה לכלים, ולכן ה-AI לא יכול לערוך מסמכים.',
  ...
  hi: {
    ...
    setAiKeyOptional: 'वैकल्पिक — केवल सुरक्षित प्रॉक्सी के लिए',
    setAiAnalysisModelHint: 'चित्र पढ़ने वाला विज़न मॉडल। खाली छोड़ें तो चैट मॉडल उपयोग होगा।',
    setAiAnalysisSameAsChat: 'चैट मॉडल जैसा',
    setAiDaemon: 'Ollama सेवा',
    setAiDaemonUp: 'Ollama {version} · {n} मॉडल इंस्टॉल',
    setAiDaemonDown: 'Ollama से संपर्क नहीं हुआ। इसे “ollama serve” से चालू करें।',
    setAiNoModels: 'अभी कोई मॉडल नहीं — “ollama pull llama3.2” से एक लाएँ।',
    setAiRefreshModels: 'ताज़ा करें',
    setAiLocalHint:
      'सब कुछ आपके कंप्यूटर पर Ollama के ज़रिए चलता है। न खाता, न API कुंजी — कोई डेटा बाहर नहीं जाता।',
    setAiModelNoTools: 'यह मॉडल टूल कॉल नहीं कर सकता, इसलिए AI दस्तावेज़ संपादित नहीं कर पाएगा।',
  ...
  'zh-TW': {
    ...
    intgLoading: '正在檢查…',
    intgUpdateDue: 'skill 有新版本可更新',
    setAiKeyOptional: '可留空（僅反向代理需要）',
    setAiAnalysisModelHint: '讀取圖片的視覺模型。留空則沿用對話模型。',
    setAiAnalysisSameAsChat: '與對話模型相同',
    setAiDaemon: 'Ollama 服務',
    setAiDaemonUp: 'Ollama {version} · 已安裝 {n} 個模型',
    setAiDaemonDown: '無法連線 Ollama。請先執行「ollama serve」。',
    setAiNoModels: '尚未安裝模型 — 先執行「ollama pull llama3.2」。',
    setAiRefreshModels: '重新整理',
    setAiLocalHint: '全部在本機透過 Ollama 執行。不需帳號與 API Key，資料不會離開本機。',
    setAiModelNoTools: '此模型不支援工具呼叫，AI 無法編輯文件。',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服務商',
    setAiModelId: '模型',
    setAiApiKey: 'API Key',
