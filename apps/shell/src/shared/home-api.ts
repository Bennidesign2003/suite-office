...
export interface HomeApi {
  ...
  /** local Ollama daemon: reachable? which models are installed? (the only AI setup state there is) */
  ollamaStatus(): Promise<OllamaCatalog>
  ...
  /** provider catalog (one entry: Ollama) with its default daemon host */
  ...
  /** reachability check for a (possibly unsaved) media provider config */
...
export const HOME_CHANNELS = {
  ...
  ollamaStatus: 'home:ollama-status',
